/**
 * Компонент кнопки для планирования one-to-one встречи
 * Полноширинная горизонтальная кнопка в стиле glass morphism
 */
class ScheduleOneToOneButton {
    constructor(options = {}) {
        this.options = {
            onClick: options.onClick || (() => console.log('Запланировать one-to-one')),
            text: options.text || 'Запланировать one-to-one',
...
window.ScheduleOneToOneButton = ScheduleOneToOneButton;
